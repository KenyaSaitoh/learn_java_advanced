...
public class PredicateMain1 {
    ...
    private void process() {
        ...
        boolean flag3 = checkUserSpeck(alice, new UserSpec<User>() {
            @Override
    ...
    private boolean checkUserSpeck(User user, UserSpec<User> userSpec) {
